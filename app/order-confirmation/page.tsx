          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">{order.customerInfo.city}, {order.customerInfo.zipCode}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {order.items.map((item) => (
              <div key={item.id} className="flex justify-between items-start border-b pb-4 last:border-0">
                <div className="flex-1">
                  <p className="font-semibold text-gray-900">{item.pizzaName}</p>
                  <p className="text-sm text-gray-600">Size: {item.size} • Qty: {item.quantity}</p>
                </div>
                <p className="font-semibold text-gray-900">{formatPrice(item.totalPrice * item.quantity)}</p>
              </div>
            ))}
          </div>
